...
// //                       <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewbox="0 0 64 64" style={{ enableBackground: "new 0 0 512 512" }}
// //  xml:space="preserve">
// //                         <g>
...
//     //         <span className="subtitle text-uppercase mb-3" data-aos="fade-up">Our Services</span>
//     //         <h2 className="mb-3 fs-5" data-aos="fade-up" data-aos-delay="100">
//     //           Our Health Card Services offer a comprehensive solution for patients seeking medical treatment, combining the benefits of multiple hospital collaborations, Cash Less treatment options, and progressive insurance coverage from various insurance companies.
//     //         </h2>
//     //       </div>
//     //     </div>
...
//     //               <span className="icon mb-4 d-inline-block" dangerouslySetInnerHTML={{ __html: service.icon }} />
...
//               <div className="service-card p-4 rounded-4 h-100 d-flex flex-column gap-3">
//                 <div className="text-center" dangerouslySetInnerHTML={{ __html: service.icon }} />
//                 <h3 className="text-center fs-5">{service.title}</h3>
...
// // const services = [
// //   {
// //     title: 'Multiple Hospital Collaborations',
// //     description:
// //       'We have partnered with a network of leading hospitals to ensure that our members receive high-quality medical care. Our collaborations include:.',
// //     icon: `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewbox="0 0 64 64" style="enable-background:new 0 0 512 512" xml:space="preserve">
// // //                         <g>
// // //                           <path d="M50.327 4H25.168a6.007 6.007 0 0 0-6 6v5.11h-8.375a3.154 3.154 0 0 0-3.12 3.18v5.47a1 1 0 0 0 .724.961 3.204 3.204 0 0 1 0 6.097 1 1 0 0 0-.724.962v5.49a3.154 3.154 0 0 0 3.12 3.18H34.5c-2.147 8.057 9.408 12.135 12.77 4.441a1 1 0 0 0-1.841-.779 4.778 4.778 0 1 1-4.403-6.636c1.039-.159 2.453 1.082 3.063-.225.449-1.37-1.383-1.598-2.336-1.734V31.8a1 1 0 0 0-.72-.96 3.21 3.21 0 0 1 0-6.11 1 1 0 0 0 .72-.96v-5.48a3.154 3.154 0 0 0-3.12-3.18H21.168V10a4.004 4.004 0 0 1 4-4h3.21l1.24 3.066a3.982 3.982 0 0 0 3.708 2.503h8.826a3.984 3.984 0 0 0 3.71-2.503L47.1 6h3.228a4.004 4.004 0 0 1 4 4v1.6a1 1 0 0 0 2 0V10a6.007 6.007 0 0 0-6-6ZM38.633 17.11a1.153 1.153 0 0 1 1.12 1.18v4.792a5.234 5.234 0 0 0 0 9.405V35.6a6.789 6.789 0 0 0-4.333 2.85H10.793a1.153 1.153 0 0 1-1.12-1.18v-4.8a5.232 5.232 0 0 0 0-9.401V18.29a1.153 1.153 0 0 1 1.12-1.18Zm5.375-8.793a1.994 1.994 0 0 1-1.856 1.252h-8.826a1.991 1.991 0 0 1-1.854-1.252l-.934-2.312H44.94Z" fill="currentColor" opacity="1" data-original="#000000"></path>
// // //                           <path d="M55.327 14.6a1 1 0 0 0-1 1V54a4.004 4.004 0 0 1-4 4H25.168a4.004 4.004 0 0 1-4-4V43.45a1 1 0 0 0-2 0V54a6.007 6.007 0 0 0 6 6h25.16a6.007 6.007 0 0 0 6-6V15.6a1 1 0 0 0-1-1Z" fill="currentColor" opacity="1" data-original="#000000"></path>
// // //                           <path d="M41.185 54.52a1 1 0 0 0 0-2h-6.891a1 1 0 0 0 0 2ZM24.713 28.383a.853.853 0 1 1-.835 1.028.998.998 0 0 0-1.184-.775c-1.765.61-.18 2.94 1.017 3.265-.271 1.919 2.27 1.926 2-.003a2.852 2.852 0 0 0-.998-5.515.851.851 0 1 1 .821-1.084 1 1 0 0 0 1.926-.54 2.857 2.857 0 0 0-1.749-1.893v-.518a1 1 0 0 0-2 0v.521a2.852 2.852 0 0 0 1.002 5.514Z" fill="currentColor" opacity="1" data-original="#000000"></path>
...
// //     description:
// //       'Manage budgets, track spending, and plan financial goals with user-friendly tools that simplify personal finance.',
// //     icon:`<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewbox="0 0 64 64" style="enable-background:new 0 0 512 512" xml:space="preserve">
// // //                         <g>
// // //                           <path d="m57.936 58.647-4.47-11.871a9.542 9.542 0 0 0-5.914-5.693l-7.659-2.609-1.944-2.116v-2.62a13.043 13.043 0 0 0 4.739-5.175 14.256 14.256 0 0 0 3.237.14 2.909 2.909 0 0 0 2.905-2.906v-5.382a2.895 2.895 0 0 0-1.495-2.523 13.84 13.84 0 0 0-2.807-7.777 1 1 0 0 0-1.597 1.205 11.879 11.879 0 0 1 2.386 6.19c-.012-.01-2.017.036-1.987-.023-4.064-11.113-18.668-11.126-22.702.024h-1.875c.73-9.938 13.556-14.987 21.539-8.81a1 1 0 0 0 1.196-1.605c-9.394-7.24-24.311-1.02-24.754 10.758a2.895 2.895 0 0 0-1.566 2.561v5.382a2.909 2.909 0 0 0 2.905 2.906c.4-.042 2.932.115 3.213-.122a12.843 12.843 0 0 0 4.542 5.038v2.757l-1.825 2.184-7.553 2.521a9.547 9.547 0 0 0-5.917 5.695l-4.47 11.871a1.008 1.008 0 0 0 .935 1.352H49.97a1 1 0 0 0 0-2H36.123l-2.985-7.876 2.014-2.491 2.009 1.746a1.007 1.007 0 0 0 1.643-.594l1.322-8.118 6.785 2.312a7.549 7.549 0 0 1 4.682 4.504L55.555 58H53.97a1 1 0 0 0 0 2H57a1.007 1.007 0 0 0 .936-1.353zm-13.77-39.136h1.759a.906.906 0 0 1 .905.904v5.382a.906.906 0 0 1-.905.906h-1.759zm-24.334 7.192h-1.759a.906.906 0 0 1-.905-.906v-5.382a.906.906 0 0 1 .905-.904h1.76s.038 5.959 0 7.192zm12.146-15.6a10.16 10.16 0 0 1 9.15 6.288L38.85 18.43a4.677 4.677 0 0 1-4.986-.747 6.633 6.633 0 0 0-7.78-.736l-3.91 2.325c1.2-4.704 5.135-8.169 9.803-8.169zM21.832 23.168V21.8l5.273-3.133a4.632 4.632 0 0 1 5.433.51 6.72 6.72 0 0 0 7.15 1.07l2.098-.957a12.113 12.113 0 0 1 .38 2.98c-.464 14.245-18.826 15.065-20.334.9zM35.95 34.706v1.718l-3.968 5.464-4.153-5.473v-1.78a11.242 11.242 0 0 0 8.12.071zm-9.164 3.643 3.852 5.075-3.771 3.28-1.206-7.008zM8.444 58l3.96-10.516a7.551 7.551 0 0 1 4.681-4.505l6.724-2.245 1.387 8.06a1.007 1.007 0 0 0 1.641.585l2.01-1.746 2.013 2.491L27.875 58zm25.54 0h-3.97L32 52.763zm-1.985-9.65-1.642-2.03 1.642-1.428 1.642 1.427zm5.12-1.658-3.772-3.28 3.693-5.085 1.224 1.332z" fill="currentColor" opacity="1" data-original="currentColor"></path>
// // //                         </g>
...
//   const services = [
//     {
//       icon: '<i class="bi bi-hospital fs-1 text-primary"></i>',
//       title: 'Multiple Hospital Collaborations',
//       description: `We have partnered with a network of leading hospitals to ensure that our members receive high-quality medical care. Our collaborations include:
      
// - Top-rated hospitals: Choose from a wide range of accredited hospitals equipped with specialized teams.
// - Streamlined referrals: Access specialists within our network easily and efficiently.
// - Emergency services: Quick response times and priority access for members.`
//     },
//     {
//       icon: '<i class="bi bi-cash-stack fs-1 text-success"></i>',
//       title: 'Cash Less Treatment',
//       description: `Our cashless treatment feature allows members to receive medical services without upfront payments. Benefits include:

// - Direct billing: Hospitals will directly bill us for the treatment.
// - Convenience: Focus on recovery without worrying about payments.
// - Transparent updates: Get real-time updates on costs and coverage.`
//     },
//     {
//       icon: '<i class="bi bi-shield-plus fs-1 text-info"></i>',
//       title: 'Progressive Insurance Coverage',
//       description: `We collaborate with multiple insurance providers to offer a range of coverage options:

// - Flexible plans: Choose plans suited to your needs.
...
//   const services = [
//     {
//       icon: '<i class="bi bi-hospital fs-1 text-danger"></i>', // red
//       title: 'Multiple Hospital Collaborations',
//       description: [
//         'Top-rated hospitals: Choose from a wide range of accredited hospitals equipped with specialized teams.',
//         'Streamlined referrals: Access specialists within our network easily and efficiently.',
...
//     },
//     {
//       icon: '<i class="bi bi-cash-stack fs-1 text-danger"></i>', // green
//       title: 'Cash Less Treatment',
//       description: [
//         'Direct billing: Hospitals will directly bill us for the treatment.',
//         'Convenience: Focus on recovery without worrying about payments.',
...
//     },
//     {
//       icon: '<i class="bi bi-shield-plus fs-1 text-danger"></i>', // blue
//       title: 'Progressive Insurance Coverage',
//       description: [
//         'Flexible plans: Choose plans suited to your needs.',
//         'Comprehensive coverage: Includes hospitalization, outpatient, preventive care.',
...
//             <span className="subtitle text-uppercase mb-3" data-aos="fade-up">Our Services</span>
//             <h2 className="mb-3 fs-5" data-aos="fade-up" data-aos-delay="100">
//               Our Health Card Services offer a comprehensive solution for patients seeking medical treatment, combining the benefits of multiple hospital collaborations, cashless treatment options, and progressive insurance coverage from various insurance companies.
//             </h2>
//           </div>
//         </div>
...
//       title: 'Life Line Health Card',
//       description: [
//         'Affordable membership: Low-cost health card for everyone.',
//         'Wider acceptance: Usable across partner hospitals and clinics.',
//         'Preventive care: Free annual checkups and wellness packages.',
//         'Health tracking: Monitor your medical records digitally.',
//       ]
//     },
//     {
//       icon: '<i class="bi bi-hospital fs-1 text-danger"></i>',
//       title: 'Multiple Hospital Collaborations',
//       description: [
//         'Top-rated hospitals: Choose from a wide range of accredited hospitals equipped with specialized teams.',
//         'Streamlined referrals: Access specialists within our network easily and efficiently.',
...
//     },
//     {
//       icon: '<i class="bi bi-shield-plus fs-1 text-primary"></i>',
//       title: 'Progressive Insurance Coverage',
//       description: [
//         'Flexible plans: Choose plans suited to your needs.',
//         'Comprehensive coverage: Includes hospitalization, outpatient, preventive care.',
...
//               <span className="subtitle text-uppercase mb-2 text-muted fs-6">Our Services</span>
...
//               </div>
//               <h3 className="text-center fs-5 mb-2">Conclusion</h3>
//               <p className="mb-0 fs-6">
//                 Our Health Card Services are designed to enhance your healthcare experience. With strong hospital collaborations, cashless treatment options, and progressive insurance coverage, you can focus on what matters most: your health. <br />
//                 <strong>Join us today</strong> and take the first step toward a worry-free healthcare journey!
//               </p>
//             </div>
//           </div>
//         </div>
